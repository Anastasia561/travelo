...
public class LimitedDiscount extends Discount {
    ...
    public LimitedDiscount(LocalDateTime startTime, LocalDateTime endTime, double discountAmount, String promoCode, String ageGroupDiscountDescription, AgeGroup ageGroup) {
